...
{
    /// <summary>
    /// InsertFieldAdornment places red boxes behind all the "a"s in the editor window
    /// </summary>
    internal sealed class InsertFieldAdornment
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InsertFieldAdornment"/> class.
        /// </summary>
        /// <param name="view">Text view to create the adornment for</param>
        public InsertFieldAdornment(IWpfTextView view)
        {
            ...
            this.layer = view.GetAdornmentLayer("InsertFieldAdornment");
